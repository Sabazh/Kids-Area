...
const schoolPage = () => {
  const repeatedData = Array.from({ length: 144 }, (_, index) => ({
    ...schoolData[index % schoolData.length],
    id: index + 1,
  }))
      ...
      <div className="cont">
        ...
        <div className="my-5-0 sm:my-10-0">
          <Pagination
            ...
            background="bg-yellow px-1-8 py-0-8 rounded-1-0"
          />
        </div>
      </div>
